...
WD <- "D:/projects/pRatio_R"
WD <- "D:/projects/pRatio/pRatio_R"
...
# get the list of MSF files from the two ways:
files <- c()

# 1. from the given directories
...
# 2. from the Experiment and the pattern of folders
} else if ( exists("Expto") && exists("Patern") && length(Expto) != 0 && length(Patern) != 0 ) {
  ...
  stop("Give a list of input directories or the list of Expto and MSFfolders")
}
